...
class groupbuy_order_create extends b2c_api_rpc_request
{
    /**
     * 构造方法
     * @param object app
    ...
    {	
        ...
        $sdf_order = array(
			...
			'shipping_id'=>array($store_id=>$sdf['delivery']['shipping_id']),
			'is_protect'=>array($store_id=>($sdf['delivery']['is_protect'][$sdf['delivery']['shipping_id']] ? $sdf['delivery']['is_protect'][$sdf['delivery']['shipping_id']] : 0)),
			'currency'=>$sdf['payment']['currency'],
