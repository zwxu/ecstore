...
class pointprofessional_point_task_order implements pointprofessional_point_task_interface
{
	 /**
     * 公开构造方法
     * @params app object
