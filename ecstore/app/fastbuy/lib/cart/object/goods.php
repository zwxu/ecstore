 ...
 * $ 2010-04-28 19:46 $
 */
class fastbuy_cart_object_goods extends b2c_cart_object_goods{
    ...
    function _get_products($aProductId) {
        ...
        $sSql = "SELECT
                     ...
                     g.goods_type, g.nostore_sell, g.min_buy,g.type_id,g.cat_id,g.image_default_id,p.spec_info,p.spec_desc,p.price,p.weight,p.mktprice as p_mktprice,g.mktprice as g_mktprice,
