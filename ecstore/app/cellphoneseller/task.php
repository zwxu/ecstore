<?php
class cellphoneseller_task
{
    public function pre_install()
    {
        kernel::log('Initial cellphoneseller');
        kernel::single('base_initial', 'cellphoneseller')->init();
    }
    
    public function post_install($options)
    {
        $conf = app::get('cellphone')->getConf('image.cellphone.set');
        app::get('cellphoneseller')->setConf('imageseller.set', $conf);
