...
class b2c_ctl_admin_code extends base_controller
{
	...
	function error_view($auth_error_msg)
    {
		...
		echo $render->display('admin/activa_code.html');
		exit;
	}
