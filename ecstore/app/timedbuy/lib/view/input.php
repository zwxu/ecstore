<?php
 ...
 class timedbuy_view_input{
     ...
     function input_goods($params){
        ...
        $app = app::get($app_id);        
        $o = $app->model($object);
        $render = new base_render(app::get('timedbuy'));
		...
		//$listGoods = $o->getList('*',$tmp_filter);
		//$goodFiler = $o->_filter($tmp_filter);
		//echo '<pre>';print_r($goodFiler);exit;
