...
class scorebuy_ctl_site_order extends b2c_ctl_site_order{
    var $noCache = true;
     ...
     public function create()
    {
        ...
        $order_data = array();
        $obj_order_create = kernel::single("scorebuy_order_create");
        // 加入订单能否生成的判断
        ...
        if ($result)
        {
            ...
            /** 订单创建结束后执行的方法 **/
            $odr_create_service = kernel::servicelist('score_order.create');
