<?php
//举报管理
class complain_ctl_site_seller_reports extends business_ctl_site_member
{
	/**
	 * 构造方法
    ...
    public function reports_main($npage=1){ 
       ...
       // echo '<pre>';print_r($aData['data']);echo '</pre>';
        $this->pagination($nPage,$aData['page'],'main','','complain',$ctl='site_seller_reports');
     ...
     public function _output(){
        $this->action_view='seller/reports/'.$this->action_view;
    ...
    public function get_store_info($store_id){
     ...
     public function save_comment(){
        ...
        $url = $this->gen_url(array('app' => 'complain','ctl' => 'site_seller_reports', 'act'=>'show_comment','arg0'=>$_POST['reports_id']));
        $isBigImage=false;
    ...
    public function addSave(){ 
        ...
        $error_url = $this->gen_url(array('app' => 'complain','ctl' => 'site_seller_reports', 'act'=>'add','arg0'=>$_POST['from_member_id'],'arg1'=>$_POST['goods_id'],'arg2'=>$_POST['store_id']));
        $success_url=$this->gen_url(array('app'=>'complain','ctl'=>'site_seller_reports','act'=>'reports_main'));
